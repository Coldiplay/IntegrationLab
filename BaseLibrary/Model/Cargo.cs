...
public partial class Cargo : ObservableValidator
{
    ...
    [ObservableProperty] [MaxLength(200)] public partial string? Description { get; set; }

    [Required] [ObservableProperty] public partial DateTime DateAdded { get; set; } = DateTime.Now;

    [Required] [ObservableProperty] public partial double Weight { get; set; }

    [Required] [ObservableProperty] public partial Dimensions Dimensions { get; set; }

    [ObservableProperty] public partial DangerLevel? DangerLevel { get; set; }
